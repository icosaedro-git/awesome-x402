...
- [Agent Café](https://402.coffee) - The hello world of agent payments — a live mainnet x402 endpoint any agent can pay to "buy a coffee" and get a machine-readable receipt. Real USDC on Base via the Coinbase CDP facilitator, $0.10–$100. Idempotent retries, receipt recovery, and a public wall of paid orders. Speaks plain standard x402 — works with any client, first try. [Docs](https://api.402.coffee/docs) | [Menu JSON](https://api.402.coffee/menu) | [Examples](https://github.com/englishdoggy/agentcafe-examples)
