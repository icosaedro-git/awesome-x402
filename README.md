...
- [DPX Settlement Protocol](https://github.com/untitledfinancial/dpx-mcp) - 13-tool MCP server for institutional cross-border settlement on Base mainnet. 10-layer Stability Oracle (climate, macro, FX, ESG, supply chain, earth systems), ESG scoring with 6 institutional providers, FX quotes, and USDC settlement at 1.385% all-in. MiCA-aligned, GENIUS Act compatible, x402 pay-per-call intelligence. `npx @untitledfinancial/dpx-mcp`. ([npm](https://www.npmjs.com/package/@untitledfinancial/dpx-mcp)) ([Docs](https://docs.dpx.untitledfinancial.com))
