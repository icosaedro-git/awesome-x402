...
- **[DeFi Yield Decision Engine](https://defi-yield-engine-production.up.railway.app/mcp)** — Risk-adjusted yield recommendations across 548 DeFi protocols and 115 chains. Returns one opinionated recommendation with reasoning — 97% fewer tokens than raw DeFiLlama. Tools: get_best_yield, explain_risk, compare_yields. Free resources: market overview + risk glossary. 0.02–0.05 USDC/call on Base. MCP streamable-http.
